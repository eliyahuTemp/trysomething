...
function getChatLoad() {
	...
	function getChatText() {
		...
		if (receiveReq.readyState == 4 || receiveReq.readyState == 0) {
			...
			receiveReq.open("GET", 'getChat.asp?chat=' + chat_id + '&last=' + lastMessage + '&SessionID=' + SessionID, true);
	...
	function sendChatText() {
		...
		if (sendReq.readyState == 4 || sendReq.readyState == 0) 
		{
			...
			sendReq.open("POST", 'getChat.asp?chat=' + chat_id + '&last=' + lastMessage + '&SessionID=' + SessionID, true);
	...
	function resetChat() {
		if (sendReq.readyState == 4 || sendReq.readyState == 0) {
			sendReq.open("POST", 'getChat.asp?chat=1&last=' + lastMessage, true);
			sendReq.setRequestHeader('Content-Type','application/x-www-form-urlencoded');
	...
	function getChatUsers() {
		...
		if (receiveReqUsers.readyState == 4 || receiveReqUsers.readyState == 0) {
			...
			url = 'getChatUsers.asp?chat=' + chat_id + '&last=' + lastUserUpdate + '&SessionID=' + SessionID + '&username=' + encodeURIComponent(username) + '&test=11'
	...
	function handleReceiveChatUsers() {
		...
		if (receiveReqUsers.readyState == 4) {
			...
			for (i=n_messages-1; i>=0 ; i--) {
				var user_node = message_nodes[i].getElementsByTagName("user");
				var lastUserUpdate_node = message_nodes[i].getElementsByTagName("LastUserUpdate");
				...
				{
				    TmpStr1 += '<tr><td width="20" ><img src="http://chat.2all.co.il/PNG/UserGuest.jpg" align=texttop border=0 title="אורח" class="media-object"></td>';
					TmpStr1 += '<td><font class="chat_username">' + user_node[0].firstChild.nodeValue + '</font>' + FuncGetUserLinks2(U,L,S) + '</td></tr>';
				}
				else if (LogOnType[0].firstChild.nodeValue=='2')
				{
				    TmpStr2 += '<tr><td width="20" ><img src="http://chat.2all.co.il/PNG/UserMember.jpg" align=texttop border=0 title="משתמש רשום" class="media-object"></td>';
					TmpStr2 += '<td><font class="chat_username">' + FuncGetUserLinks(user_node[0].firstChild.nodeValue) + '</font>' + FuncGetUserLinks2(U,L,S) + '</td></tr>';
				}
				else if (LogOnType[0].firstChild.nodeValue=='3')
				{
				    TmpStr3 += '<tr><td width="20" ><img src="http://chat.2all.co.il/PNG/UserAdmin.jpg" align=texttop border=0 title="מנהל" class="media-object"></td>';
					TmpStr3 += '<td><font class="chat_username">' + FuncGetUserLinks(user_node[0].firstChild.nodeValue) + '</font>' + FuncGetUserLinks2(U,L,S) + '</td></tr>';
				}
				else if (LogOnType[0].firstChild.nodeValue=='4')
				{
				    TmpStr4 += '<tr><td width="20" ><img src="http://chat.2all.co.il/PNG/UserAdminMain.jpg" align=texttop border=0 title="מנהל ראשי" class="media-object"></td>';
					TmpStr4 += '<td><font class="chat_username">' + FuncGetUserLinks(user_node[0].firstChild.nodeValue) + '</font>' + FuncGetUserLinks2(U,L,S) + '</td></tr>';
				}		
				else if (LogOnType[0].firstChild.nodeValue=='5')
				{
				    TmpStr5 += '<tr><td width="20" ><img src="http://chat.2all.co.il/PNG/UserMember2.jpg" align=texttop border=0 title="אורח כבוד" class="media-object"></td>';
					TmpStr5 += '<td><font class="chat_username">' + FuncGetUserLinks(user_node[0].firstChild.nodeValue) + '</font>' + FuncGetUserLinks2(U,L,S) + '</td></tr>';
				}		
				else
				{
				    TmpStr0 += '<tr><td><img src="http://chat.2all.co.il/PNG/UserView.jpg" align=texttop border=0 title="משתמש לצפיה בלבד" class="media-object"></td>';
					TmpStr0 += '<td><font class="chat_username">' + user_node[0].firstChild.nodeValue + '</font></td></tr>';
				}
	...
	function FuncAddPrivateMsg(U,L,S,T)
	{
			...
			if (sendReq.readyState == 4 || sendReq.readyState == 0) 
			{
				...
				sendReq.open("POST", 'getChat.asp?chat=' + chat_id + '&last=' + lastMessage + '&SessionID=' + SessionID + '&SessionIDTo=' + S, true);
